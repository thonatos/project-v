  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-12 lg:max-w-7xl lg:mx-auto">
      <header className="mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight mb-4 text-[var(--color-text)]">Trading</h1>
        <p className="text-lg text-[var(--color-text-muted)] mb-6">投资、交易、市场分析相关文档，共 {docs.length} 篇</p>
